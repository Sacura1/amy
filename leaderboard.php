...
<body class="min-h-screen text-white relative">
        ...
        <main class="flex-grow container mx-auto px-4 py-12 md:py-24">
            ...
            <div class="container mx-auto px-4 mt-12 md:mt-16">
                <div class="max-w-4xl mx-auto">
                    ...
                    <!-- Information Box -->
                    <div class="glass-card p-6 md:p-8 mb-8 md:mb-12" style="background: linear-gradient(135deg, rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.8)); border: 2px solid rgba(255, 215, 0, 0.5);">
                        <div class="space-y-4 text-yellow-300">
                            ...
                            <p class="text-sm md:text-base leading-relaxed">
                                New supporters who join mid-week, pick up 300+ $AMY, and actually stick with it can still make the leaderboard.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="glass-card overflow-hidden">
                        ...
                        <div class="bg-gradient-to-r from-yellow-900/40 to-orange-900/40 p-4 md:p-5 border-b-2 border-yellow-400/30">
                            <div class="flex items-center justify-between flex-wrap gap-3">
                                <div class="flex items-center gap-3">
                                    <div class="icon-badge-small">
                                        📊
                                    </div>
                                    <h3 class="text-lg md:text-xl font-black text-yellow-300">Top Performers</h3>
                                </div>
                                <div class="flex items-center gap-2">
                                    <span class="text-xs text-gray-400">🔄 Updated:</span>
                                    <span class="text-xs md:text-sm text-yellow-400 font-semibold" id="last-updated">Loading...</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="hidden md:grid grid-cols-12 gap-4 px-6 py-4 bg-black/30 border-b border-yellow-400/20 text-xs uppercase tracking-wider text-gray-400 font-bold">
                            <div class="col-span-12">Eligible Users (300+ AMY + X Connected)</div>
                        </div>

                        <!-- Leaderboard Content -->
                        <div class="p-4 md:p-6" id="leaderboard-container">
                            <!-- Leaderboard rows will be inserted here -->
                            <div class="text-center py-12">
                                <div class="loading-spinner mb-4"></div>
                                <p class="text-gray-400 font-semibold">Loading leaderboard...</p>
                            </div>
                        </div>
                        ...
                        <div id="empty-state" class="hidden text-center py-12 px-4">
                            ...
                            <p class="text-xl md:text-2xl font-bold text-gray-300 mb-2">No eligible users yet</p>
    ...
    <script src="/wp-content/themes/amy/profile.js?v=6"></script>
